package com.android.mobile.toast.model;
...
import com.android.mobile.toast.manager.MsgManager;
...
public class AppMsg {
    ...
    public AppMsg setLayoutGravity(int gravity) {
        mLayoutParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT, gravity);
        return this;
    }
